...
namespace BeatLeader_Server.Models
{
    public class ModifiersRating 
    {
        ...
        public float SSPeakSustainedEBPM { get; set; }
        ...
        public float FSPeakSustainedEBPM { get; set; }
        ...
        public float SFPeakSustainedEBPM { get; set; }
        ...
        public float BFSPeakSustainedEBPM { get; set; }
        ...
        public float BSFPeakSustainedEBPM { get; set; }
    ...
    public class ModifiersMap
    {
        ...
        public static string[] KnownModifiers = new string[] {
            "DA",
            "FS",
            "SF",
            "SS",
